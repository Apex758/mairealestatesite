...
import { Settings, Cloud, Key, RefreshCw } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-lg font-medium">Deployment Settings</h2>
        </div>
      ...
      <div className="flex gap-4">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-gray-900 text-white py-3 rounded-lg hover:bg-gray-800"
        >
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 disabled:opacity-50"
        >
